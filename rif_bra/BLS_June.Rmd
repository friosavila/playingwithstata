...
- Other Household production not including Care for others
- Active Child care
- Adult Care
  ]
.pull-right[
...
- All imputation methods (**RP, RPP and SM**) use similar structure except for Sup-Care overlapping

  - For SM, we use .red[*imputed/transferred*] values from ATUS
  - For RP and RPP we use conditional means
...
$$HPC_i = \sum  w_j * ht_{ij} \ \forall \ j=[ck, othp, cc, aa, ecc, eac, sc]$$
- For preferred method, we use $w_j$ is different by activity.

- For BEA method, $w_j=w_g$ for all but j=[ecc, eac, sc]. For this, activities $w_j=0$.
...
|RPP|	56.4	|43.4|	9.1|	27.0|	6.2|	1.0	|1.2	|0.5	|8.0|	3.4|
...
|RPP|	719.6|	576.5	|120.1|	359.6	|103.3	|15.3	|20.0|	7.8|	65.9|	27.7|
...
|RPP	|0.375|	0.430	|0.386	|0.420|0.055|0.011|
...
.panel[.panel-name[RPP]

| RPP                        | Share | Gini  | Contribution |
|---------------------------|-------|-------|--------------|
