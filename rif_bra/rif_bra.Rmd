---
title: "Estimation and Interpretation of RIF-Regressions"
subtitle: "Going Beyond Linear Relationships"
...
- CQR because you compare two distributions conditional on one [categorical] variable changing ( $x_2=0 \ vs \ x_2=1$ ), everything else constant (at some values).
...
## OB_RIF Decompositions: Refinement FFL(2018)
...
This Slides:[https://tinyurl.com/rifbra](https://friosavila.github.io/playingwithstata/rif_bra/rif_bra.html)
]
.pull-right[
