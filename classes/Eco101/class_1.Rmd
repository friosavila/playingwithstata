...
subtitle: "The Hardest Class You will have at Levy"  
author: 
  - "Fernando Rios-Avila"
date: '`r Sys.Date()`'
output:
...
-------------+----------------------------------   F(1, 933)       =     74.35
       Model |  6724.72887         1  6724.72887   Prob > F        =    0.0000
    Residual |  84389.6836       933  90.4498217   R-squared       =    0.0738
-------------+----------------------------------   Adj R-squared   =    0.0728
       Total |  91114.4125       934  97.5529042   Root MSE        =    9.5105

------------------------------------------------------------------------------
     wage_hr | Coefficient  Std. err.      t    P>|t|     [95% conf. interval]
-------------+----------------------------------------------------------------
        educ |   1.221525    .141667     8.62   0.000     .9435019    1.499548
       _cons |   5.869815   1.933219     3.04   0.002     2.075854    9.663777
------------------------------------------------------------------------------
```
...
style_mono_accent(base_color = "#23395c", 
 colors = c(
  red = "#f34213",
  purple = "#3e2f5b",
  orange = "#ff8811",
