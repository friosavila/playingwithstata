...
{phang}{bf:. {stata `"xi, noomit:waffle_plot i.cand [w=pop], color(cranberry*0.7 navy*0.7 forest_green*.5) sctopt(msize(4) mlcolor(black%50))  by(inc, title("1992 President Elections") subtitle("by Family Income") note(Reprinted from the NYT)) legend(order(1 "Clinton" 2 "Bush" 3 "Perot") cols(3))"'}}{p_end}
